...
const allMenuItems = [
  ...
  { path: '/reportes-produccion', title: 'Reporte Producción', desc: 'Estadísticas de productos más feteados', icon: 'ph-chart-bar', color: 'var(--accent-success)', bg: 'rgba(16, 185, 129, 0.1)', roles: ['Admin', 'Referente', 'Feteador', 'Envasador', 'Colaborador'] },
  { path: '/reportes-despacho-semanal', title: 'Despacho Semanal', desc: 'Despachos semanales de Lunes a Sábado', icon: 'ph-truck-trailer', color: 'var(--accent-primary)', bg: 'rgba(59, 130, 246, 0.1)', roles: ['Admin', 'Referente', 'Preparador', 'Feteador', 'Envasador', 'Colaborador', 'Usuario'] },
  { path: '/reportes-proyeccion', title: 'Proyección & Stock', desc: 'Estimación de días de stock según demanda', icon: 'ph-chart-line-up', color: 'var(--accent-info)', bg: 'rgba(139, 92, 246, 0.1)', roles: ['Admin', 'Referente', 'Preparador', 'Feteador', 'Envasador', 'Colaborador', 'Usuario'] },
  ...
  { path: '/comparaciones-variabilidad', title: 'Comparaciones de Variabilidad', desc: 'Seguimiento y comparación de ajustes entre dos códigos', icon: 'ph-scales', color: 'var(--accent-primary)', bg: 'rgba(59, 130, 246, 0.1)', roles: ['Admin', 'Referente', 'Preparador', 'Feteador', 'Envasador', 'Colaborador', 'Usuario'] },
